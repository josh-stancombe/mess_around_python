...
for i in daily_transactions_split:
  transaction_clean = []
  for j in i:
    transaction_clean.append(j.replace("\n","").strip(" "))
  transactions_clean.append(transaction_clean)

for dataset in transactions_clean:
  customers.append(dataset[0])
  sales.append(dataset[1])
  thread_sold.append(dataset[2])
